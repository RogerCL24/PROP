...
public class Distribucion {
    // Atributos
    /**
     * Par de enteros altura, longitud. Son los valores de la estantería de la distribución.
     */
    private Pair<Integer, Integer> Prestage;
    /**
     * Lista de productos (Strings) de la distribución.
     */
    private List<String> Dist;
    /**
     * Nombre de la distribución. Hace de clave primaria de la clase, identifica a la distribución.
     */
    private String nom;
    /**
     * Estrategia (algoritmo) que se usa para generar el orden de los productos en la distribución.
     */
    private Estrategia estrategia;
    /**
     * Mapa para gestionar las posiciones de los productos.
     */
     ...
     * @param dist Lista de productos.
     * @param nom Nombre de la distribución.
     * @param estrategia Estrategia de la distribución.
     * @param mapa Mapa de la distribución.
     */
    public Distribucion(Pair<Integer, Integer> prestage, List<String> dist, String nom, Estrategia estrategia, Map<String, Integer> mapa) {
    ...
    /**
     * Obtiene la estrategia utilizada en la distribución.
     * @return Estrategia usada en la distribución.
     */
    ...
    /**
     * Obtiene el mapa de productos y sus posiciones de la distribución.
     * @return Mapa de productos y sus posiciones de la distribución.
     */
