...
public class CjtLlistesProductes {
    ...
    /**
     *  Mapa que asocia nombres de listas con instancias de LlistaProductes
     */
    private Map<String, LlistaProductes> conjuntoListas;
    ...
    /**
     * Constructor que inicializa un conjunto de listas con un mapa de listas de productos con sus nombres con sus
     * claves.
     * @param conjuntoListas Mapa con las listas de productos que tendrá el conjunto.
     */
    public CjtLlistesProductes(Map<String, LlistaProductes> conjuntoListas) {
        this.conjuntoListas = conjuntoListas;
    }
